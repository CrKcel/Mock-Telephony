...
public class IRadioConfigImpl extends IRadioConfig.Stub {
    ...
    private volatile IRadioConfigResponse mRadioConfigResponse;
    private volatile IRadioConfigIndication mRadioConfigIndication;
    ...
    public IRadioConfigImpl(
        ...
        // Register events
        mMockModemConfigInterfaces[mSubId].registerForNumOfLiveModemChanged(
                mHandler, EVENT_NUM_OF_LIVE_MODEM_CHANGED, null);
        mMockModemConfigInterfaces[mSubId].registerForPhoneCapabilityChanged(
                mHandler, EVENT_PHONE_CAPABILITY_CHANGED, null);
        mMockModemConfigInterfaces[mSubId].registerForSimSlotStatusChanged(
                ...
                switch (msg.what) {
                    ...
                    case EVENT_SIM_SLOT_STATUS_CHANGED:
                        ...
                        if (ar != null && ar.exception == null) {
                            ...
                            if (mSimSlotStatus != null) {
                                for (int i = 0; i < mSimSlotStatus.length; i++) {
    ...
    public void setResponseFunctions(
        ...
        mService.registerRadioInterface(
                MockModemService.RADIO_INTERFACE_CONFIG, radioConfigResponse.asBinder());
    }
