...
public interface MockModemConfigInterface {
    ...
    String DEFAULT_BASEBAND_VERSION = "MPSS.DI.3.0.c1.7-00001-1";
    String DEFAULT_IMEI = "353285102955892";
    String DEFAULT_IMEISV = "27";
    String DEFAULT_ESN = "80B11468";
    String DEFAULT_MEID = "021B11FE0482A5";
