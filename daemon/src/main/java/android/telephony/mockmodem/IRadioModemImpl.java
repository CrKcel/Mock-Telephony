...
public class IRadioModemImpl extends IRadioModem.Stub {
    ...
    private volatile IRadioModemResponse mRadioModemResponse;
    private volatile IRadioModemIndication mRadioModemIndication;
    ...
    public IRadioModemImpl(
        ...
        // Register events
        mMockModemConfigInterfaces[mSubId].registerForBasebandVersionChanged(
                mHandler, EVENT_BASEBAND_VERSION_CHANGED, null);
        mMockModemConfigInterfaces[mSubId].registerForDeviceIdentityChanged(
    ...
    public void setResponseFunctions(
        ...
        mService.registerRadioInterface(
                MockModemService.RADIO_INTERFACE_MODEM, radioModemResponse.asBinder());
    }
    ...
    public void requestShutdown(int serial) {
        ...
        // The bootstrap mock has no physical modem to power down; acknowledging
        // keeps the framework's shutdown state machine consistent with "modem off".
        RadioResponseInfo rsp = mService.makeSolRsp(serial);
        try {
    ...
    public void setRadioPower(
        ...
        synchronized (mCacheUpdateMutex) {
            ...
            mMockModemConfigInterfaces[mSubId].setRadioState(mRadioState, TAG);
        }
        RadioResponseInfo rsp = mService.makeSolRsp(serial);
